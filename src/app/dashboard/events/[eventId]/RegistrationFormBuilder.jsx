    ...
    <div className="space-y-6">
              ...
              {field.type === "DATE" && (
                <div className="mt-4 p-4 rounded-xl bg-white/5 border border-white/10 space-y-4">
                  <div className="flex items-center gap-2 text-gray-400 mb-2">
                    ...
                    <span className="text-sm font-medium">Date Constraints (Optional)</span>
                  </div>

                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <Label className="text-gray-300 text-xs">Min Date</Label>
                      <Input
                        type="date"
                        value={field.minDate || ""}
                        onChange={(e) => updateField(index, "minDate", e.target.value)}
                        className="mt-1 h-10 bg-black/20 border-white/10 text-white rounded-xl"
                      />
                    </div>
                    <div>
                      <Label className="text-gray-300 text-xs">Max Date</Label>
                      <Input
                        type="date"
                        value={field.maxDate || ""}
      ...
      <div className="mt-8">
        <div className="flex items-center justify-between mb-4">
          ...
          {formExists && instructions.length > 0 && (
            <Button
